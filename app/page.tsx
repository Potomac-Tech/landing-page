...
import {
  ...
  IntelligencePlatformVisual,
} from './intelligence-platform';
import { BriefingForm, BriefingIntro } from './briefing-form';
import { ScrollStory, StoryMedia } from './scroll-story';
...
export default function Home() {
  return (
    <main className="site-shell">
      ...
      <ScrollStory>
        <section className="hero" id="top" data-story-scene="pathfinder">
          <div className="hero-copy">
            <div className="hero-title-wrap">
              ...
              <p className="hero-summary">
                Potomac collects proprietary data from the Moon&apos;s surface
                to better inform space industrialists financing, building, and
                securing the Moon.
              </p>
            </div>
        ...
        <StoryMedia scene="pathfinder">
          ...
          >
            <img
              ...
              sizes="(min-width: 1100px) and (min-height: 720px) 50vw, 100vw"
            ...
            <div className="visual-caption">
              <span>Site intelligence / Lunar south pole</span>
            </div>
          </div>
        </StoryMedia>
        ...
        >
          <div className="pathfinder-copy">
            ...
            <p className="pathfinder-summary">
              ...
              customers a far lower-cost way to put hardware on the Moon—and
              opens the market to many more participants.
            </p>
            <div className="pathfinder-context">
              <p>
                CubeSats helped open orbit beyond large, expensive spacecraft,
                bringing small-satellite missions within reach of university
                teams and new companies. Pathfinder brings that market-opening
                idea to the lunar surface.
              </p>
            </div>
            ...
            <div className="pathfinder-heritage">
              ...
              <p>
                ...
                from orbit, Pathfinder adapts a NASA flight-qualified design for
                a focused lunar scouting mission.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          <div className="market-intro">
            ...
            <div className="market-copy">
              <p>
                Potomac provides proprietary lunar data and intelligence to
                space industrialists. Don’t buy the mission risk – buy the data.
          ...
          <div className="company-layout">
            <div className="company-copy">
              ...
              <p className="company-summary">
                Potomac combines reconnaissance instinct, space systems
                execution, and market intelligence to build the infrastructure
                lunar decision-makers are missing.
              </p>
        ...
        <section
          ...
          id="briefing"
          data-story-scene="briefing"
        >
          <BriefingIntro />
        </section>
        <StoryMedia scene="briefing">
          <BriefingForm />
        </StoryMedia>
      </ScrollStory>
